...
public class JwtTokenUtil implements Serializable {
    ...
    @Value("${spring.application.remember-me-access-token-validity}")
    ...
    public String generateToken(String username, boolean rememberMe) {
        return doGenerateToken(username, rememberMe);
    }
    ...
    private String doGenerateToken(String subject, boolean rememberMe) {
        ...
        long validity = rememberMe ? rememberMeAccessTokenValidity : defaultAccessTokenValidity;
        return Jwts.builder()
                .setClaims(claims)
                .setIssuer("IBAR")
